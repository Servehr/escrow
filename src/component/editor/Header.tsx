...
export default function Header() 
{
  ...
  return (
      ...
      >
          <div 
              className='container flex px-5 py-6 md:py-4 hover:py-6 bg-blue-100 gap-2 overflow-x-auto'
          >   
              <div 
          ...
          <div 
              className='container flex px-5 py-6 md:py-4 bg-blue-100 hover:py-6 bg-blue-100 gap-2 overflow-x-auto'
          > 
              <div 
                  className="relative"
              >
